...
| CNS-01 | Consent | ePrivacy Art. 5(3) — consent before storage or access `ePrivacy:5:3`<br>GDPR Art. 4(11) — what consent is `GDPR:4:11`<br>GDPR Art. 7(1) — the controller must be able to show consent was given `GDPR:7:1` | cns-01 v1 |
| CNS-02 | Consent | ePrivacy Art. 5(3) — consent before storage or access `ePrivacy:5:3`<br>GDPR Art. 7(3) — withdrawal as easy as consent `GDPR:7:3` | cns-02 v1 |
...
| CNS-05 | Consent | GDPR Art. 7(3) — refusing must be as easy as agreeing `GDPR:7:3`<br>GDPR Art. 4(11) — consent is a freely given choice `GDPR:4:11`<br>ePrivacy Art. 5(3) — storage or access only with consent `ePrivacy:5:3` | cns-05 v1 |
...
| TRF-01 | Transfers | GDPR Art. 44–49 — transfers outside the EEA need a basis `GDPR:44`<br>Case law CJEU, C-311/18 — a transfer needs a level of protection essentially equivalent to the EU’s at the receiving end `CJEU:C-311/18` | trf-01 v1 |
| VND-06 | Recipients | Case law LG München I, 3 O 17493/20 — damages for embedded web fonts `LG München I:3 O 17493/20`<br>GDPR Art. 6(1) — a lawful basis for passing the visitor’s address to the font host `GDPR:6:1` | vnd-06 v1 |
...
| APP-01 | Notice | GDPR Art. 13(1)(c) — the purposes the data is collected for `GDPR:13:1:c`<br>GDPR Art. 5(1)(a) — processing must be transparent `GDPR:5:1:a` | app-01 v1 |
...
| SUB-03 |  | GDPR Art. 28(2) — sub-processors need prior authorisation `GDPR:28:2` | sub-03 v1 |
| TRF-01 | Transfers | GDPR Art. 44–49 — transfers outside the EEA need a basis `GDPR:44`<br>Case law CJEU, C-311/18 — a transfer needs a level of protection essentially equivalent to the EU’s at the receiving end `CJEU:C-311/18` | trf-01 v1 |
| VND-06 | Recipients | GDPR Art. 6(1) — a lawful basis for passing the visitor’s address to the font host `GDPR:6:1`<br>Case law LG München I, 3 O 17493/20 — damages for embedded web fonts `LG München I:3 O 17493/20` | vnd-06 v1 |
| VND-11 |  | GDPR Art. 13(1)(e) — recipients or categories of recipients `GDPR:13:1:e` | vnd-11 v1 |
| CLK-01 | Recipients | GDPR Art. 5(1)(a) — processing must be transparent `GDPR:5:1:a`<br>GDPR Art. 5(2) — the controller must be able to show it `GDPR:5:2` | clk-01 v1 |
| APP-01 | Notice | GDPR Art. 13(1)(c) — the purposes the data is collected for `GDPR:13:1:c`<br>GDPR Art. 5(1)(a) — processing must be transparent `GDPR:5:1:a` | app-01 v1 |
