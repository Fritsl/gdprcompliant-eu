...
Generated from `packages/db/migrations/meta/0024_snapshot.json` by `scripts/schema-doc.mjs`.
...
- check case_events_type: `"type" in ('case_opened', 'scan_started', 'scan_completed', 'scan_failed', 'finding_raised', 'finding_closed', 'finding_regressed', 'fix_verification_failed', 'check_undetermined', 'question_asked', 'question_answered', 'check_requested', 'internal_access', 'deep_scan_authorised', 'advice_recorded', 'dive_requested', 'artefact_generated', 'artefact_signed', 'artefact_published', 'colleague_invited', 'colleague_joined', 'reminder_sent', 'invitation_revoked', 'watch_run', 'meeting_requested', 'note_added', 'locale_overridden', 'claim_rejected', 'claim_requested', 'case_claimed', 'case_expired', 'export_produced', 'deletion_requested', 'vendor_resolved', 'trust_published', 'trust_unpublished', 'share_created', 'share_revoked')`
...
| source_ref | text | not null |
| case_id | text | not null |
| kind | text | not null, default 'upward' |
| token | text | not null |
...
- case_id → cases(id)
- unique index case_shares_token (token)
- index case_shares_case_idx (case_id)
- check case_shares_kind: `"kind" in ('upward')`
- check case_shares_token_length: `length("case_shares"."token") >= 32`
