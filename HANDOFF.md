...
**65 of 112 done.** Phase 0 and phase 1 are complete; phase 2 is 24 of 34, phase 3 has
...
findings with the hosts named, and finding assembly with the severity table and re-scan
reconciliation are in. The database is up (`pnpm db:up`); nothing in phase 1 is open.
