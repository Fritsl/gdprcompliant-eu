...
**64 of 112 done.** Phase 0 and phase 1 are complete; phase 2 is 23 of 34, phase 3 has
...
that check a choice was registered, and the three-pass differ that raises the seven
consent findings with the hosts named are in. The database is up (`pnpm db:up`); nothing
in phase 1 is open.
