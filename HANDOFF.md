...
**89 of 112 done.** Phase 0, phase 1 and phase 2 are complete, phase 3 has begun, DNS
...
solve, three lines of why per row, every row opening with a finding) are in. The journeys
