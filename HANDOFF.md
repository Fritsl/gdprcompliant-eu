...
**47 of 112 done.** Phase 0 and phase 1 are complete; phase 2 is 14 of 34, phase 3 has
...
runs on every push, DNS collection with its curated service map, and certificate
transparency enumeration are in. The database is up (`pnpm db:up`); nothing in phase 1 is
open.
