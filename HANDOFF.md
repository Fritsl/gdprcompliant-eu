...
**46 of 112 done.** Phase 0 and phase 1 are complete; phase 2 is 14 of 34, phase 3 has
...
runs on every push, and DNS collection with its curated service map are in. The database
is up (`pnpm db:up`); `T-07` is the last phase-1 task open.
