...
**36 of 112 done.** Phase 0 is complete and signed off; phase 1 is 10 of 11, phase 2 is
...
ledger, the case object with numbering, tokens and claiming, and the append-only timeline
with its PDF are in. The database is up (`pnpm db:up`); `T-07` is the last phase-1 task
open.
