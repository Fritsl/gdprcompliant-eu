...
**67 of 112 done.** Phase 0 and phase 1 are complete; phase 2 is 25 of 34, phase 3 has
...
reconciliation, the re-check and weekly watch loop, and the front door with the scan
worker (apps/worker, `pnpm worker:start`) that runs it are in. The database is up (`pnpm
