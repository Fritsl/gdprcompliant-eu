...
**86 of 112 done.** Phase 0, phase 1 and phase 2 are complete, phase 3 has begun, DNS
...
reader’s language) are in. The journeys suite (tests/e2e/journeys.test.ts) drives a real
scan of the estate through the front door, a fix applied by changing the fixture's
