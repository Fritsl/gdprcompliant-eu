...
**61 of 112 done.** Phase 0 and phase 1 are complete; phase 2 is 20 of 34, phase 3 has
...
and the Article 13 clause analysis with its twelve labelled policies are in. The database
is up (`pnpm db:up`); nothing in phase 1 is open.
