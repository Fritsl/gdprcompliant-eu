...
**37 of 112 done.** Phase 0 is complete and signed off; phase 1 is 10 of 11, phase 2 is
...
its PDF, and the case state machine are in. The database is up (`pnpm db:up`); `T-07` is the
last phase-1 task open.
