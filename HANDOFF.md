...
**39 of 112 done.** Phase 0 is complete and signed off; phase 1 is 10 of 11, phase 2 is
14 of 34 and phase 3 has begun. Contracts, config with the EU-only allowlist, the test
harness, record and replay, i18n, the remedy catalogue and resolver, the model client, the
...
its PDF, the case state machine, export and hard delete, and retention with its nightly
sweep are in. The database is up
