...
**69 of 112 done.** Phase 0 and phase 1 are complete; phase 2 is 25 of 34, phase 3 has
...
(apps/worker, `pnpm worker:start`) that runs it, the nightly performance budget, and the
case page with its evidence drawers and remedy buttons are in. The database is up (`pnpm
db:up`); nothing in phase 1 is open.
