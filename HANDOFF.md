...
**49 of 112 done.** Phase 0 and phase 1 are complete; phase 2 is 14 of 34, phase 3 has
...
enumeration, and invitations from a colleague are in. The database is up (`pnpm db:up`);
